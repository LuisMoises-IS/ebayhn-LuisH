...
exports.CreateCliente = function (name, correo, edad, direccion, telefono, sexo) {
...
function getCliente(_name) {
    return new Promise(function (resolve) {
        exports.Cliente.findOne({ name: _name }, function (err, data) {
            if (err) {
                resolve({});
            }
            else {
